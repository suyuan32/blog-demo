...
func (cq *CategoryQuery) QueryArticles() *ArticleQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, true, category.ArticlesTable, category.ArticlesColumn),
		)
...
func (cq *CategoryQuery) loadArticles(ctx context.Context, query *ArticleQuery, nodes []*Category, init func(*Category), assign func(*Category, *Article)) error {
	...
	for _, n := range neighbors {
		fk := n.article_category
		if fk == nil {
			return fmt.Errorf(`foreign-key "article_category" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "article_category" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
